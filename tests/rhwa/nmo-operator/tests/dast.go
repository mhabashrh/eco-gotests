...
import (
	...
	"github.com/rh-ecosystem-edge/eco-gotests/tests/rhwa/-operator/internal/farparams"
...
var _ = Describe(
	...
	Label(farparams.Label), Label("dast"), func() {
		BeforeAll(func() {
			By("Verify NMO is the only deployment in namespace")
		...
		It("Verify NMO Operator passes trivy scan without vulnerabilities", reportxml.ID("76877"), func() {
