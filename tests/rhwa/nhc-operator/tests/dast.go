...
var _ = Describe(
	...
	Ordered,
	ContinueOnFailure,
	Label(nhcparams.Label), Label("dast"), func() {
		BeforeAll(func() {
			By("Verify NHC is the only deployment in namespace")
		...
		It("Verify NHC Operator passes trivy scan without vulnerabilities", reportxml.ID("76877"), func() {
