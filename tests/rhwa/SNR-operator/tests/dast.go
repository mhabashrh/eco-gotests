...
import (
	...
	"github.com/rh-ecosystem-edge/eco-gotests/tests/rhwa/SNR-operator/internal/farparams"
...
var _ = Describe(
	...
	Label(farparams.Label), Label("dast"), func() {
		...
		It("Verify SNR Operator passes trivy scan without vulnerabilities", reportxml.ID("76877"), func() {
